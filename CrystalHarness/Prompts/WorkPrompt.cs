...
public static class WorkPrompt
{
    public const string Text =
        ...
        # References
        When you mention a specific function or piece of code, use path:line, for example CrystalHarness/Prompts/WorkPrompt.cs:12. Do not paste a whole file you just wrote; give the path.
        """;
}
