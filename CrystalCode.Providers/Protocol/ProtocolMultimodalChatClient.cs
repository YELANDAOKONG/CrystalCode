...
internal sealed class ProtocolMultimodalChatClient
    : IStreamingMultimodalChatClient, IDisposable
{
    private readonly IMultimodalProtocolCodec _codec;
    private readonly ProtocolOptions _options;
    private readonly HttpClient _httpClient;
    private readonly bool _ownsHttpClient;

    public ProtocolMultimodalChatClient(
        IMultimodalProtocolCodec codec,
    ...
    public MultimodalChatCapabilities Capabilities => _codec.Capabilities;
