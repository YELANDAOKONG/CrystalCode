...
public sealed record AnthropicOptions
{
        ...
        TimeSpan? requestTimeout = null)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(temperature), temperature, "Temperature must be between 0 and 1.");
        }
        ...
        TopP = topP;
        MaxTokens = maxTokens;
        VendorName = string.IsNullOrWhiteSpace(vendorName) ? "Anthropic" : vendorName.Trim();
